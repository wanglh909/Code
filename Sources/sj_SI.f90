...
intRm_r_S(k) = -Pep* phi_1d(k,ipp)* ( -zsi_packing(k,sideN,id)*CTJ/dt*phi_1d(k,jpp) + &
     (-phix_1d(k,jpp)) *( vintfac_packing(k,sideN,id) - zdotintfac_packing(k,sideN,id) ) ) * &
     ...
     ) *phi_1d(k,jpp) * cpintfac_packing(k,sideN,id)


intRm_z_S(k) = -Pep* phi_1d(k,ipp)* ( &
     phix_1d(k,jpp)* ( uintfac_packing(k,sideN,id) - rdotintfac_packing(k,sideN,id) ) + &
     rsi_packing(k,sideN,id)*CTJ/dt*phi_1d(k,jpp) ) * cpintfac_packing(k,sideN,id) *rintfac_packing(k,sideN,id) 
...
intRm_cp_S(k) = -Pep* phi_1d(k,ipp)* &     
     ( zsi_packing(k,sideN,id) *( uintfac_packing(k,sideN,id) - rdotintfac_packing(k,sideN,id) ) - &
     rsi_packing(k,sideN,id) *( vintfac_packing(k,sideN,id) - zdotintfac_packing(k,sideN,id) ) ) * &
     phi_1d(k,jpp)  * rintfac_packing(k,sideN,id)
...
intRm_r_S(k) = Pep* phi_1d(k,ipp)* ( zeta_right(k,id)*CTJ/dt*phi_1d(k,jpp) + &
     phix_1d(k,jpp)*( vintfac_right(k,id) - zdotintfac_right(k,id) ) ) * &
...
intRm_z_S(k) = Pep* phi_1d(k,ipp)* ( &
     -phix_1d(k,jpp)* ( uintfac_right(k,id) - rdotintfac_right(k,id) ) - &
